...
const InternationalResearchInstitutes = () => {
  ...
  useEffect(() => {
    ...
    const fetchResearch = async () => {
      try {
        const response = await axios.get('http://localhost:5001/institutes/international-researchs');
  ...
  return (
    <div className="container m-10">
      <br /><br />
      <h1 className="mb-4 mt-3 font-weight-bold text-center">International Research Institutes</h1>
...
export default InternationalResearchInstitutes;